	 ...
	 public void insertImage() {
	     ...
	     if (selectedFile != null) {
	         try {
	             ...
	             int result = ConnectEmployee.updateImageById(Integer.parseInt(employee_id), image);
		            if (result > 0) {
	 	 ...
	 	 public void saveInfor(ActionEvent event) {
	          ...
	          alert.showAndWait().ifPresent(response -> {
	              if (response == ButtonType.OK) {
	             	 ...
	             	 int n=ConnectEmployee.updateEmployeeById(Integer.parseInt(employee_id), employee);
	             	 if(n!=0) {
